...
class BulkSimulator(object):
    ...
    def simulate_dataset(self, dataset):
        ...
        # Extract celltypes
        celltypes = list(data_y.Celltype.unique()) #gbb (ensure always the same order of cell types)
    ...
    def create_subsample(self, x, y, celltypes, sparse=False):
        """
        Generate artificial bulk subsample with random fractions of celltypes
